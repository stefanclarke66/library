...
<html>
    ...
    <body>
        ...
        <h1 id="mini-title">
            ...
            <a href = '/categories' class='header-link'>  - Categories </a>
        </h1>
        
        <li> <a href = 'C:\Users\stecla\Documents\Library\Website\categories\mathematics.html' class='category-title'> Mathematics </a></li>  
